...
public class CustomerController {
	...
	@GetMapping("/customer/checkCustomerNameAvailability")
	public IdentityAvailability checkCustomerNameAvailability(@RequestParam(value = "customerName") String customerName) {
		Boolean isAvailable = !customerRepository.existsByCustomerName(customerName);
